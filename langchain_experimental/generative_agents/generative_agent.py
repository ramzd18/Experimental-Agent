  ...
  "Authorization": f"Bearer {api_key}"
        ...
        "messages": [
            ...
            "content": [
                {
                "type": "text",
                "text": f"Here is context of the wbesite you are looking at.{website_context}.Here is a summary of yourself: {summary} Given this picture of the website respond with wheter you want to click a button on the website or if you want to type something into a box. Respond with only your anwser.
