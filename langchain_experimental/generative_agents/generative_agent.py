...
Use double quotations in the dict when you return it. Return only the python dict and nothing else and make sure it is a dict. Make sure you include brackets in the dict. There should be a starting and ending bracket like in all dictionaries. They only keys in this dict should be button/search/scroll, feedback, and reasoning.
"""
                },
                {
                "type": "image_url",
